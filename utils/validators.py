...
class PhoneNumberValidator(RegexValidator):
    ...
    message = 'Phone number must be a VALID 12 digital like 98xxxxxxxxxx'
    code = 'invalide_phone_number'
...
class IBanNumberValidator(RegexValidator):
    regex = '^[a-zA-Z]{2}[0-9]{2}[a-zA-Z0-9]{4}[0-0]{7}([a-zA-Z0-9]?){0,16}$'
...
class BankCardNumberValidator(RegexValidator):
    ...
    code = 'invalid_bank_caard_number'
