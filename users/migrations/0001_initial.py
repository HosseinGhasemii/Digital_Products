# Generated by Django 5.2 on 2026-03-11 17:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that username already exists.'}, help_text='Required. 30 characters or fewer starting with a letter, letters, digital', max_length=50, unique=True, validators=[django.core.validators.RegexValidator('^[a-zA-Z][a-zA-Z0-9_\\.]+$', 'Enter a valid username starting with a-z.This value may contain only letters, number and underscore characters.')], verbose_name='username')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_type', models.PositiveBigIntegerField(choices=[(1, 'web'), (2, 'ios'), (3, 'android')], default=1)),
